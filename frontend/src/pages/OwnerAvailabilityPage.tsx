            ...
            <section className="mt-xl" aria-labelledby="weekly-title">
              ...
              <div className="mt-md flex flex-col gap-sm">
                {visibleDraft.map((day) => (
                  <article key={day.dayOfWeek} className="rounded-2xl border border-neutral-200 bg-white p-md shadow-sm transition hover:-translate-y-1 hover:shadow-lg md:grid md:grid-cols-[minmax(130px,1fr)_auto_1fr_auto] md:items-center md:gap-md">
