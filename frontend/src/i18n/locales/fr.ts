...
export default {
  ...
  vacancies: {
    ...
    spontaneousDescription: 'Vous pouvez tout de même nous envoyer votre CV, nous le garderons pour de futures opportunités.',
    ...
    certificatesRequired: 'Vous devez joindre au moins un diplôme ou certificat',
    ...
    formFieldsSectionHint: 'Sélectionnez les champs que le candidat devra remplir obligatoirement.',
