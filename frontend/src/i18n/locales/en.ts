...
export default {
  ...
  newspage:{
    ...
    adminNews: {
    title: 'News',
    description: 'Add news to keep families and the educational community informed.',
    addNews: 'Add news',
    editNews: 'Edit news',
    newnews: 'New news',
    newsTitle: 'Title',
  ...
  login: {
    ...
    forgotPasswordSuggestionDescription: 'You can recover your password at any time.',
  ...
  admin: {
    ...
    curriculums: {
      ...
      subtitle: 'Publish vacancies and review the curriculums submitted for each one.',
      ...
      deleteConfirmMessage: 'Are you sure you want to delete "{{name}}"’s application? This action cannot be undone.',
    },
    gallery: {
      title: 'Gallery',
      ...
      invalidFileType: '«{{name}}» is not a valid image. Only PNG, JPG, JPEG or SVG are allowed.',
      ...
      confirmDeleteAlbum: 'Are you sure you want to delete this album and its images?',
    ...
    servicios: {
      ...
      deleteConfirm: 'Are you sure you want to delete the plan "{{name}}"? This action cannot be undone.',
  ...
  vacancies: {
    title: 'Vacancies',
    subtitle: 'Check out the open positions at My Green Farm and apply by sending your resume.',
    publish: 'Publish vacancy',
    noVacancies: 'No vacancies available right now.',
    spontaneousTitle: "Don't see a vacancy that fits you?",
    spontaneousDescription: 'You can still send us your resume and we will keep it in mind for future opportunities.',
    ...
    applicationSentMessage: 'We received your resume. We’ll reach out if your profile matches the vacancy.',
    gotIt: 'Got it',
  },
  teacherAppointments: {
  ...
  services: {
    title: 'Our Services',
    description: 'Discover our plans designed for the care and learning of your child.',
    subscribe: 'Subscribe',
    monthly: 'Monthly',
    annual: 'Annual',
