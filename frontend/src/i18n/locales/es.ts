...
export default {
  ...
  newspage:{
    ...
    adminNews:{
      title: 'Noticias',
      description: 'Agregá noticias para mantener informadas a las familias y la comunidad educativa.',
  ...
  admin: {
    ...
    curriculums: {
      ...
      subtitle: 'Publica vacantes y revisa los currículums que llegan para cada una.',
      ...
      deleteConfirmMessage: '¿Seguro que deseas eliminar la postulación de "{{name}}"? Esta acción no se puede deshacer.',
    },
    gallery: {
      title: 'Galería',
      ...
      invalidFileType: '«{{name}}» no es una imagen válida. Solo se permiten PNG, JPG, JPEG o SVG.',
      ...
      confirmDeleteAlbum: '¿Seguro que deseas eliminar este álbum y sus imágenes?',
      ...
      confirmDeleteYear: '¿Seguro que deseas eliminar el año {{year}}? Se borrarán todos sus álbumes y fotos. Esta acción no se puede deshacer.',
    ...
    servicios: {
      ...
      deleteConfirm: '¿Seguro que deseas eliminar el plan "{{name}}"? Esta acción no se puede deshacer.',
  ...
  vacancies: {
    title: 'Vacantes',
    subtitle: 'Conoce las oportunidades laborales abiertas en My Green Farm y postúlate enviando tu currículum.',
    ...
    spontaneousDescription: 'Aun así podés enviarnos tu currículum y lo tendremos en cuenta para futuras oportunidades.',
    ...
    formFieldsSectionHint: 'Selecciona los campos que el postulante deberá completar de forma obligatoria.',
    formTitle: 'Título del puesto',
    formDescription: 'Descripción',
    applicationSentTitle: '¡Postulación enviada!',
    applicationSentMessage: 'Recibimos tu currículum correctamente. Nos pondremos en contacto si tu perfil encaja con la vacante.',
    gotIt: 'Entendido',
  },
  teacherAppointments: {
